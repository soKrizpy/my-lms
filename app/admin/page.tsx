          ...
          <div className="flex flex-col gap-1 flex-shrink-0">
            ...
            {topic?.project_link && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1 px-2 py-1 rounded-md bg-slate-800 text-white text-[11px] font-semibold hover:bg-slate-700 transition-colors whitespace-nowrap"
              >
                <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6M15 3h6m0 0v6m0-6L10 14" />
                </svg>
            ...
            <div className="flex gap-1 justify-end mt-0.5">
              ...
              {isPastJoin && !isCompleted && <span className="text-[10px] px-1.5 py-0.5 rounded bg-amber-500 text-white font-bold">Lapor</span>}
              {isCompleted && <span className="text-[10px] px-1.5 py-0.5 rounded bg-green-600 text-white font-bold">✓</span>}
            </div>
          </div>
        </div>
